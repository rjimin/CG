...
public:
    ...
    static float calculateShadowFactor(const glm::vec3 &surfacePoint, const glm::vec3 &lightSource, const std::vector<ModelTriangle> &triangles, size_t triangleIndex);
    ...
    static float getGouraudShading(glm::vec3 &cameraPosition, glm::vec3 intersectionPoint, const ModelTriangle& triangle,
                                   const std::vector<glm::vec3> &lightCluster, std::unordered_map<int, glm::vec3> &vertexNormalMap);
    static float getPhongShading(glm::vec3 &cameraPosition, glm::vec3 intersectionPoint, const ModelTriangle& triangle,
                                 const std::vector<glm::vec3> &lightCluster, std::unordered_map<int, glm::vec3> &vertexNormalMap);
